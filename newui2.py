...
try:
    ball_to_ball_model = joblib.load('/path/to/ball_to_ball_model.pkl')
except:
    ball_to_ball_model = None  # Use None as a placeholder

try:
    win_prediction_model = joblib.load('/path/to/win_prediction_model.pkl')
except:
...
# Ball-to-Ball Forecasting Page
    ...
    with col1:
        selected_batting_team_b2b = st.selectbox("Batting Team:", ["Choose an option"] + teams, key="batting_team_b2b")

    with col2:
        selected_bowling_team_b2b = st.selectbox("Bowling Team:", ["Choose an option"] + teams, key="bowling_team_b2b")

    with col3:
        selected_city_b2b = st.selectbox("City:", ["Choose an option"] + cities, key="city_option_b2b")
...
# Match Win Prediction Page
    ...
    with col1:
        selected_batting_team_win = st.selectbox("Batting Team:", ["Choose an option"] + teams, key="batting_team_win")

    with col2:
        selected_bowling_team_win = st.selectbox("Bowling Team:", ["Choose an option"] + teams, key="bowling_team_win")

    with col3:
        selected_city_win = st.selectbox("City:", ["Choose an option"] + cities, key="city_option_win")
